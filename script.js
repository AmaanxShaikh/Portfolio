...
const translations = {
    de: {
        ...
        'projects.project1.desc': 'XGBoost-Modell mit 89% F1-Score und SHAP-Erklärbarkeit',
        'projects.project2.title': 'Kreditkarten-Kundensegmentierung',
        'projects.project2.desc': 'K-Means Clustering zur Identifizierung von 5 Kundensegmenten',
        'projects.project3.title': 'Healthcare Claims Dashboard',
        'projects.project3.desc': 'Interaktives Dashboard zur Betrugserkennung im Gesundheitswesen',
        'projects.project4.title': 'Bank Churn Prediction',
        'projects.project4.desc': 'Deep Learning Modell zur Kundenabwanderungsvorhersage',
        'projects.project5.title': 'House Price Prediction',
        'projects.project5.desc': 'XGBRegressor mit 83% Genauigkeit für Immobilienpreise',
        'projects.project6.title': 'Insurance Cost Prediction',
        'projects.project6.desc': 'Lineare Regression mit R²=0.74 für Versicherungskosten',
    ...
    en: {
        ...
        'projects.project1.desc': 'XGBoost model with 89% F1-score and SHAP explainability',
        'projects.project2.title': 'Credit Card Customer Segmentation',
        'projects.project2.desc': 'K-Means clustering to identify 5 customer segments',
        'projects.project3.title': 'Healthcare Claims Dashboard',
        'projects.project3.desc': 'Interactive dashboard for healthcare fraud detection',
        'projects.project4.title': 'Bank Churn Prediction',
        'projects.project4.desc': 'Deep Learning model for customer churn prediction',
        'projects.project5.title': 'House Price Prediction',
        'projects.project5.desc': 'XGBRegressor with 83% accuracy for property prices',
        'projects.project6.title': 'Insurance Cost Prediction',
        'projects.project6.desc': 'Linear Regression with R²=0.74 for insurance costs',
        'resume.title': 'Resume',
